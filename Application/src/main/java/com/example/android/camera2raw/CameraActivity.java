...
import static com.example.android.camera2raw.CaptureRequestEx.HUAWEI_DUAL_SENSOR_MODE;
...
public class CameraActivity extends Activity implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.findViewById(R.id.picture).setOnClickListener(this);
        this.findViewById(R.id.info).setOnClickListener(this);
    ...
    private void requestCameraPermissions() {
            ...
            ActivityCompat.requestPermissions(CameraActivity.this, CAMERA_PERMISSIONS, REQUEST_CAMERA_PERMISSIONS);
